...
#====================================================================================
# Назначение: Скрипт для интерактивного поиска папок
# Автор: Hypnodancer
...
#------------------------------------------------------------------------------------
#
# - Скрипт нужен для интерактивного поиска файлов и открытия папки нужной папки из vim в ES-проводнике
# - Папка откроется при нажатии горячей клавиши <leader>t если курсор находится на строке с именем папки
#
#------------------------------------------------------------------------------------
# Обязательная секция
#------------------------------------------------------------------------------------
...
vim -c "source get_dir.vim" all_find.txt
