...
#------------------------------------------------------------------------------------
#
# - Скрипт нужен для интерактивного поиска файлов или папок и открытия найденого объекта в gui-приложении андроид
# - Папка откроется при нажатии горячей клавиши <leader>t если курсор находится на строке с именем папки или файла
#
#------------------------------------------------------------------------------------
# Обязательная секция
#------------------------------------------------------------------------------------
